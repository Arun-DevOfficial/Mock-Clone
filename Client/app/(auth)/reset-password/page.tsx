...
export default function ResetPasswordPage() {
  ...
  const onSubmit = async (data: ResetPasswordTypes) => {
    try {
      await axios.patch("https://mock-clone.onrender.com/api/auth/reset-password", data);
      reset();
    } catch (error) {
      console.log(error);
          ...
          <div className="relative group">
            ...
            <input
              ...
              className={`pl-10 pr-10 py-3 block w-full rounded-lg border ${
                errors.password ? "border-red-300 ring-red-100" : "border-gray-200 group-focus-within:border-emerald-400"
        ...
        <div>
          ...
          <div className="relative group">
            ...
            <input
              ...
              id="confirmPassword"
              className={`pl-10 pr-10 py-3 block w-full rounded-lg border ${
                errors.confirmPassword ? "border-red-300 ring-red-100" : "border-gray-200 group-focus-within:border-emerald-400"
              } focus:outline-none focus:ring-4 focus:ring-blue-50 transition-all duration-200`}
